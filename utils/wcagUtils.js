export function handleDropdownButtonKeydown(
  event,
  toggleDropdown,
  closeDropdown,
) {
...
export function attachDropdownEventListeners(
  button,
  listbox,
  toggleDropdown,
  selectOption,
  ...
  button.addEventListener("keydown", (event) =>
    handleDropdownButtonKeydown(event, toggleDropdown, closeDropdown),
  );

  listbox.querySelectorAll("li").forEach((option) => {
    option.addEventListener("click", () => selectOption(option));
    option.addEventListener("keydown", (event) =>
      handleDropdownOptionKeydown(event, [...listbox.children], {
        selectOption,
        closeDropdown,

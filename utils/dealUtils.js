...
const flightImage =
  "https://tims-personal-stuff.s3.ap-southeast-2.amazonaws.com/poolside-beach-chairs-jamaica.jpg";
...
export function updateDeals(deals, block, params, link) {
  const ul =
    block.querySelector(".deals-container ul") || document.createElement("ul");
  ul.innerHTML = "";
